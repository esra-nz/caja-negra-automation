 ...
 */
public class ReportFormatter implements Reporter, Formatter {
    private static ConfigurationLoader loader = ConfigurationLoader.getInstance();
    ...
    public ReportFormatter(File file) {
