package nz.esra.framework.reports;
...
public class Reporter {
    ...
    public static ExtentHtmlReporter getExtentHtmlReport() {
        return ReportFormatter.getExtentHtmlReport();
    }
    ...
    public static ExtentReports getExtentReport() {
        return ReportFormatter.getExtentReport();
    }
    ...
    private static ExtentTest getCurrentStep() {
        return ReportFormatter.stepTestThreadLocal.get();
    }

    private static ExtentTest getCurrentScenario() {
        return ReportFormatter.scenarioThreadLocal.get();
    }
}
